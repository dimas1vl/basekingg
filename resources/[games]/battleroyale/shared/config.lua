...
Config.BR = {
    ...
    safezone = {
        initialCenter = vector3(0.0, 0.0, 0.0),
        ...
        presets = {
            { radius = 1500.0, damage = 0,  displayTime = 60,  shrinkTime = 0  },
            { radius = 1100.0, damage = 1,  displayTime = 120, shrinkTime = 60 },
            { radius = 400.0,  damage = 3,  displayTime = 90,  shrinkTime = 60 },
            { radius = 200.0,  damage = 5,  displayTime = 60,  shrinkTime = 60 },
            { radius = 120.0,  damage = 10, displayTime = 45,  shrinkTime = 60 },
            { radius = 75.0,   damage = 20, displayTime = 30,  shrinkTime = 60 },
            { radius = 40.0,   damage = 30, displayTime = 30,  shrinkTime = 60 },
        },
    },
