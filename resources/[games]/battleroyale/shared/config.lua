...
Config.BR = {
	...
	safezone = {
		initialCenter = {
			vector3(288.82, -856.33, 0.0),
			vector3(-24.03, -427.52, 0.0),
			vector3(230.31, -222.90, 0.0),
		},
		initialCenterRadius = 300.0,
		initialRadius = 2500.0,
		dynamic = {
			candidates = 8,
			areaRadius = 250.0,
			minImprovement = 0.25,
		...
		presets = {
			{ radius = 2500.0, damage = 5, displayTime = 120, shrinkTime = 120 },
			{ radius = 1500.0, damage = 5, displayTime = 60, shrinkTime = 120 },
			{ radius = 900.0, damage = 5, displayTime = 60, shrinkTime = 120 },
			{ radius = 750.0, damage = 5, displayTime = 60, shrinkTime = 120 },
			{ radius = 500.0, damage = 5, displayTime = 60, shrinkTime = 120 },
			{ radius = 350.0, damage = 10, displayTime = 60, shrinkTime = 90 },
			{ radius = 250.0, damage = 15, displayTime = 60, shrinkTime = 90 },
			{ radius = 150.0, damage = 20, displayTime = 60, shrinkTime = 90 },
			{ radius = 100.0, damage = 25, displayTime = 60, shrinkTime = 90 },
			{ radius = 50.0, damage = 30, displayTime = 60, shrinkTime = 90 },
			{ radius = 25.0, damage = 50, displayTime = 60, shrinkTime = 90 },
			{ radius = 0.01, damage = 50, displayTime = 60, shrinkTime = 90 },
		},
	},
