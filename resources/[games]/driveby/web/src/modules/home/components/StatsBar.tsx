...
export default function StatsBar({ kills, deaths, killStreak, players }: StatsBarProps) {
  return (
    <>
<div className="absolute content-stretch flex gap-[12px] items-center justify-center right-[calc(75%+164px)] top-[40px] w-[276px]">
        <StatItem icon={imgVector8} iconSize={{ w: 'w-[11px]', h: 'h-[13px]' }} value={kills} />
        <StatItem icon={imgDeathsIcon} iconSize={{ w: 'w-[11px]', h: 'h-[13px]' }} value={deaths} arrow={imgStatArrowDeaths} />
