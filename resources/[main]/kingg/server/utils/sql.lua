...
CreateThread(function()
    local tables = {
        users = [[
            CREATE TABLE IF NOT EXISTS `users` (
                ...
                `role` ENUM('user','admin','spec') NULL DEFAULT 'user' COLLATE 'utf8mb4_uca1400_ai_ci',
                ...
                `name` VARCHAR(150) NULL DEFAULT NULL COLLATE 'utf8mb4_uca1400_ai_ci',
                `gender` ENUM('male','female') NULL DEFAULT NULL COLLATE 'utf8mb4_uca1400_ai_ci',
        ...
        CREATE TABLE IF NOT EXISTS `bans` (
            ...
            `reason` VARCHAR(255) NULL DEFAULT '' COLLATE 'utf8mb4_uca1400_ai_ci',
        ...
        CREATE TABLE IF NOT EXISTS `identifiers` (
            ...
            `identifier` VARCHAR(255) NULL DEFAULT NULL COLLATE 'utf8mb4_uca1400_ai_ci',
	...
	`id` INT(11) NOT NULL AUTO_INCREMENT,
	`user_id` INT(11) NULL DEFAULT NULL,
	`category` ENUM('smg','rifle','pistol') NULL DEFAULT NULL COLLATE 'utf8mb4_uca1400_ai_ci',
	`skin_id` VARCHAR(255) NULL DEFAULT NULL COLLATE 'utf8mb4_uca1400_ai_ci',
...
;
    ...
    local migrations = {
        [[ALTER TABLE `users` ADD COLUMN IF NOT EXISTS `gender` ENUM('male','female') NULL DEFAULT NULL COLLATE 'utf8mb4_uca1400_ai_ci' AFTER `name`]],
